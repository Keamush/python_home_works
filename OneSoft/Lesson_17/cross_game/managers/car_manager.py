...
from OneSoft.Lesson_17.cross_game.game_lib.sprites.car import Car
from OneSoft.Lesson_17.cross_game.game_lib.settings.game_settings import CAR_COLORS, SCREEN_HEIGHT, SCREEN_WIDTH
